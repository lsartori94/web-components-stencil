...
@Component({
  tag: 'bebop-stock-price',
  styleUrl: './bebop-stock-price.scss',
  shadow: true
})
export class BebopStockPrice {
  stockInput: HTMLInputElement;
  // initialStockSymbol: string;

  // Auto reference to host component
  ...
  @Listen('bebopSymbolSelected', {target: 'body'})
  ...
  render() {
    ...
    if (this.loading) {
      dataContent = <bebop-spinner></bebop-spinner>;
    }
    return [
